  ...
  <div class="pref-editor">
    ...
    <compound>
      ...
      <template #children>
        ...
        ></font-text-box>
        <text-box
          description="文本编辑器最大宽度"
          notes="留空使用主题默认值，否则使用带单位的数字，如 'ch'（字符）、'px'（像素）或 '%'（百分比）。"
